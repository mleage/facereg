    ...
    def writeStudentIntoExecl(self):
        try:
            ...
            for i in range(len(re)):
                ...
                sheet1.write(i + 1, 6, str(re[i][7]))
                sheet1.write(i + 1, 7, re[i][9])
                sheet1.write(i + 1, 8, str(re[i][10]))
                sheet1.write(i + 1, 9, str(re[i][11]))
                sheet1.write(i + 1, 10, str(re[i][12]))
                sheet1.write(i + 1, 11, str(re[i][13]))
                sheet1.write(i + 1, 12, str(re[i][14]))
                sheet1.write(i + 1, 13, str(re[i][16]))
                sheet1.write(i + 1, 14, str(re[i][17]))
                sheet1.write(i + 1, 15, str(re[i][18]))
                # 保存文件
